const HOST = 'https://api.purse.io'
const OFFERS_ENTRYPOINT = `${HOST}/api/v1/orders/open`
const RATES_ENTRYPOINT = `${HOST}/api/v1/btc/rates`

const COUNTRIES = [null, 'US', 'UK', 'CA', 'JP']
